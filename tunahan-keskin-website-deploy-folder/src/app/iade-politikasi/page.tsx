  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#070B12] text-[#F8FAFC]">
      ...
      <main className="flex-1 py-16 px-6 max-w-4xl mx-auto w-full">
        ...
        <h1 className="font-display text-4xl text-white uppercase mb-6">İADE POLİTİKASI</h1>
        <div className="bg-[#111827] border border-white/10 p-8 rounded-2xl space-y-4 text-sm text-[#D9D9D9] leading-relaxed">
          <p>Dijital indirilebilir ürünlerde indirme gerçekleşmeden önce, koçluk paketlerinde ise hizmet başlamadan önceki 14 gün içerisinde iade yapılabilir.</p>
        </div>
      </main>
      <Footer />
    </div>
